...
## Project Structure
    ...
    ├── testapiautodatamod_111630  # Django project configurations
...
1. Clone this repo and `cd testapiautodatamod_111630`
...
2. Clone this repo and `cd testapiautodatamod_111630`
